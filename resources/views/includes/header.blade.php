<header class="fixed z-50 flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-3 shadow-sm">
    <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between">
        ...
        <div id="hs-navbar-example" class="hidden hs-collapse overflow-hidden transition-all duration-300 basis-full grow sm:block" aria-labelledby="hs-navbar-example-collapse">
            <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                <a class="font-medium text-gray-600 hover:text-blue-400 focus:outline-hidden focus:text-gray-400" href="/" aria-current="page">Home</a>
                <a class="font-medium text-gray-600 hover:text-blue-400 focus:outline-hidden focus:text-gray-500" href="/about">About</a>
                <a class="font-medium text-gray-600 hover:text-blue-400 focus:outline-hidden focus:text-gray-400" href="/gallery">Gallery</a>
            </div>
        </div>
    </nav>
</header>
